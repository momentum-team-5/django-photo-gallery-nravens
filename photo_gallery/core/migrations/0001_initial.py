    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('comments', models.ManyToManyField(through='core.Comment', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            model_name='photo',
            constraint=models.UniqueConstraint(condition=models.Q(default=True), fields=('gallery',), name='unique_default_photo'),
        ),
    ]
